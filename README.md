# Fondamenti di cybersecurity (93466)
...
[Questo sito](https://csunibo.github.io/fondamenti-di-cybersecurity) elenca
...
| `prove`        | `(scritto\|totale\|parziale\d\|orale(\d?)\|progetto(\d?))-\d{4}(-\d{2}-\d{2})?(-[a-z0-9]+)?-(testo\|soluzione\|risorse)(-[a-z0-9]+)?\.?[a-zA-Z0-9]*` | `parziale2-testo-2022-05-24-b.pdf`, `totale-soluzione-2022-05-31-incompleto.pdf`, `orale-testo-2022-06-08.md` |
